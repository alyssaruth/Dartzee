...
object DatabaseSanityCheck
{
    ...
    {
        val tempTable1 = DatabaseUtil.createTempTable("ParticipantToRoundCount", "ParticipantId VARCHAR(36), RoundCount INT, FinalRoundNumber INT")
                ?: return
        ...
        sb.append(" FROM Round rnd, Dart drt, $tempTable1 zz")
