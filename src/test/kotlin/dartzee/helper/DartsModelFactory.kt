...
fun predictableGolfModel(
    ...
    every { model.getStopThresholdForDartNo(capture(stopThresholdSlot)) } answers
        {
            hmDartNoToStopThreshold.getValue(stopThresholdSlot.captured)
        }
