...
class SanityCheckResultDanglingIdFieldsTest : AbstractTest() {
    ...
    fun `Should allow auto fix to be cancelled`() {
        ...
        expectQuestionDialog("Are you sure you want to delete 10 rows from Game?", "No")
    ...
    fun `Should auto fix successfully`() {
        ...
        expectQuestionDialog("Are you sure you want to delete 10 rows from Game?", "Yes")
    ...
    fun `Should show an error if something goes wrong`() {
        ...
        expectQuestionDialog("Are you sure you want to delete 1 rows from Foo?", "Yes")
