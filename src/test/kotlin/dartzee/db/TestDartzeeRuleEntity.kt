...
class TestDartzeeRuleEntity: AbstractEntityTest<DartzeeRuleEntity>()
{
    ...
    fun `Should retrieve rows for a template, sorted by ordinal`()
    {
        ...
        val ruleA3 = insertDartzeeRule(entityName = TableName.DartzeeTemplate, entityId = templateA.rowId, ordinal = 3)
        val ruleA1 = insertDartzeeRule(entityName = TableName.DartzeeTemplate, entityId = templateA.rowId, ordinal = 1)
        val ruleA2 = insertDartzeeRule(entityName = TableName.DartzeeTemplate, entityId = templateA.rowId, ordinal = 2)

        insertDartzeeRule(entityName = TableName.DartzeeTemplate, entityId = templateB.rowId, ordinal = 1)
        insertDartzeeRule(entityName = TableName.Game, entityId = templateA.rowId, ordinal = 4)
    ...
    fun `Should delete rows for a template`()
    {
        ...
        insertDartzeeRule(entityName = TableName.DartzeeTemplate, entityId = templateA.rowId, ordinal = 3)
        insertDartzeeRule(entityName = TableName.DartzeeTemplate, entityId = templateA.rowId, ordinal = 1)
        insertDartzeeRule(entityName = TableName.DartzeeTemplate, entityId = templateA.rowId, ordinal = 2)

        val ruleB1 = insertDartzeeRule(entityName = TableName.DartzeeTemplate, entityId = templateB.rowId, ordinal = 1)
        val gameRule = insertDartzeeRule(entityName = TableName.Game, entityId = templateA.rowId, ordinal = 4)
    ...
    fun `Should retrieve rules for a game, sorted by ordinal`()
    {
        ...
        val ruleA3 = insertDartzeeRule(entityName = TableName.Game, entityId = gameA.rowId, ordinal = 3)
        val ruleA1 = insertDartzeeRule(entityName = TableName.Game, entityId = gameA.rowId, ordinal = 1)
        val ruleA2 = insertDartzeeRule(entityName = TableName.Game, entityId = gameA.rowId, ordinal = 2)

        insertDartzeeRule(entityName = TableName.Game, entityId = gameB.rowId, ordinal = 1)
        insertDartzeeRule(entityName = TableName.DartzeeTemplate, entityId = gameA.rowId, ordinal = 4)
