...
class TestGameStatisticsPanelGolf :
    AbstractGameStatisticsPanelTest<GolfPlayerState, GameStatisticsPanelGolf>() {
    ...
    fun `Should get best, avg and worst hole state correct`() {
        val roundOne =
            makeGolfRound(1, listOf(makeDart(1, 1, segmentType = SegmentType.OUTER_SINGLE)))
    ...
    /**
     * 4-2-3. You've gained 1 (and also lost 1). Method should return 1 for the original '4' gamble.
     * I guess.
     */
    @Test
