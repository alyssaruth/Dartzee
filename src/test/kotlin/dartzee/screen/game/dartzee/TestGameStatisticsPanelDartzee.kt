...
class TestGameStatisticsPanelDartzee :
    AbstractGameStatisticsPanelTest<DartzeePlayerState, GameStatisticsPanelDartzee>() {
    ...
    fun `Should correctly identify the longest streak`() {
        ...
        val extraResults = listOf(DartzeeRoundResult(2, true, 20), DartzeeRoundResult(3, true, 5))
    ...
    fun `Should correctly identify the hardest rule that has been passed`() {
        ...
        val extraResults = listOf(DartzeeRoundResult(5, true, 20), DartzeeRoundResult(6, false, 5))
