...
class TestDartsScorerX01 : AbstractTest() {
    ...
    fun `Should render historic rounds correctly`() {
        ...
        rows.shouldContainExactly(roundOne + 480, roundTwo + 380)
    ...
    fun `Should include the current round`() {
        ...
        val rows = scorer.tableScores.getRows()
        rows.shouldContainExactly(roundOne + 480, listOf(Dart(20, 1), Dart(20, 1), null, null))
    ...
    fun `Should include checkout suggestions when appropriate`() {
        ...
        scorer.tableScores
            .getRows()
            .first()
            .shouldContainExactly(DartHint(17, 3), DartHint(25, 2), null, null)
        ...
        scorer.tableScores
            .getRows()
            .first()
            .shouldContainExactly(Dart(20, 3), DartHint(1, 1), DartHint(20, 2), null)
        ...
        scorer.tableScores
            .getRows()
            .first()
            .shouldContainExactly(Dart(20, 3), Dart(20, 1), null, null)
    }
    ...
    fun `Should toggle checkout suggestions on pause`() {
        val participant =
            insertParticipant(finishingPosition = 4, dtFinished = DateStatics.END_OF_TIME)
