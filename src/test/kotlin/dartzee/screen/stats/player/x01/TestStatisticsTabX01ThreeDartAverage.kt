...
import dartzee.drtInnerNineteen
import dartzee.drtInnerTwenty
...
class TestStatisticsTabX01ThreeDartAverage : AbstractTest() {
    ...
    private fun StatisticsTabX01ThreeDartAverage.overallAverage() =
        getChild<NumberField> { it.testId == "overallAverage" }

    private fun StatisticsTabX01ThreeDartAverage.overallAverageOther() =
        getChild<NumberField> { it.testId == "overallAverageOther" }

    private fun StatisticsTabX01ThreeDartAverage.missPercent() =
        getChild<NumberField> { it.testId == "missPercent" }

    private fun StatisticsTabX01ThreeDartAverage.missPercentOther() =
        getChild<NumberField> { it.testId == "missPercentOther" }

    private fun StatisticsTabX01ThreeDartAverage.chart() =
        getChild<ChartPanel>().chart.plot as XYPlot
