...
class TestAchievementX01StylishFinish : AbstractMultiRowAchievementTest<AchievementX01StylishFinish>()
{
    ...
    fun `Should populate achievement row with correct details`()
    {
        ...
        val a = AchievementEntity.retrieveAchievement(AchievementType.X01_STYLISH_FINISH, pt.playerId)!!
    ...
    private fun insertParticipantAndDarts(startingScore: Int, vararg darts: Dart): ParticipantEntity
    {
