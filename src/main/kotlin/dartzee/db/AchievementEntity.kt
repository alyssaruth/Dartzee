 ...
 */
class AchievementEntity(database: Database = mainDatabase) :
    AbstractEntity<AchievementEntity>(database) {
    // DB Fields
    var playerId: String = ""
    ...
    companion object {
        ...
        fun retrieveAchievement(achievementType: AchievementType, playerId: String) =
            AchievementEntity()
                .retrieveEntity("PlayerId = '$playerId' AND achievementType = '$achievementType'")
        ...
        fun insertForUniqueCounter(
            ...
            if (!hits.contains(counter)) {
                ...
                triggerAchievementUnlock(
                    achievementRows.size,
                    achievementRows.size + 1,
                    achievementType,
                    playerId,
                    gameId,
                    allRows
        ...
        private fun triggerAchievementUnlock(
            oldValue: Int,
            newValue: Int,
            achievementType: AchievementType,
            playerId: String,
