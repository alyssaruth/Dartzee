...
open class Dart(
    ...
    fun hitClockTarget(clockType: ClockType) =
        score == startingScore && isRightClockMultiplier(clockType)

    fun hitAnyClockTarget(clockType: ClockType) =
        hitClockTarget(clockType) ||
            (clockTargets.contains(score) && isRightClockMultiplier(clockType))
