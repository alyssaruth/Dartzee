...
class RoundTheClockMatchScreen(match: DartsMatchEntity, participants: List<IWrappedParticipant>):
    DartsMatchScreen<ClockPlayerState>(MatchSummaryPanel(match, MatchStatisticsPanelRoundTheClock(match.gameParams)), match, participants)
{
