...
open class GameStatisticsPanelDartzee : AbstractGameStatisticsPanel<DartzeePlayerState>() {
    ...
    private fun getScoreRow(desc: String, f: (i: List<Int>) -> Number) =
