...
class MovingAverageChartPanel(private val parentTab: AbstractStatisticsTab) :
    ...
    private fun adjustTickboxes() {
        ...
        // Go through what's left and add any others that are required by the graph (e.g. just added
        // a comparison)
        ...
        checkBoxes
            ...
            .forEach { graphCollection.removeSeries(getGraphSeriesIndexForCheckBox(it)) }
