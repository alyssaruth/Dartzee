...
fun translatePoint(pt: Point, radius: Double, degrees: Double): Point {
    ...
    val quadrant =
        getQuadrantForAngle(positiveAngle)
            ?: return translatePointAlongAxis(pt, radius, positiveAngle)
...
/**
 * For the given angle, return the Quadrant. Returns null if there is none (because we're on an
 * axis).
 */
