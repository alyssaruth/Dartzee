...
object PreferenceUtil {
    ...
    /** Ints */
    fun getIntValue(prefStr: String, returnDefault: Boolean = false) =
        getStringValue(prefStr, returnDefault).toInt()
    ...
    /** Doubles! */
    fun getDoubleValue(prefStr: String, returnDefault: Boolean = false) =
        getStringValue(prefStr, returnDefault).toDouble()
    ...
    /** Bools */
    fun getBooleanValue(prefStr: String, returnDefault: Boolean = false) =
        getStringValue(prefStr, returnDefault).toBoolean()
